...
public class APIReleaseOperationResponse {
  ...
  public APIReleaseOperationResponse cid(String cid) {
    this.cid = cid;
    return this;
  }
  ...
  **/
  ...
  public APIReleaseOperationResponse isCompleted(Boolean isCompleted) {
  ...
  **/
  ...
  public APIReleaseOperationResponse operationMetadata(APIOperationMetadata operationMetadata) {
  ...
  **/
  ...
  public APIReleaseOperationResponse error(APIReceiptOperationErrorInformation error) {
    this.error = error;
    return this;
  }
  ...
  **/
  ...
  public APIReleaseOperationResponse response(APIReceipt response) {
