...
public class APIRedeemAssetsResponse {
  ...
  public APIRedeemAssetsResponse cid(String cid) {
    this.cid = cid;
    return this;
  }
  ...
  **/
  ...
  public APIRedeemAssetsResponse isCompleted(Boolean isCompleted) {
  ...
  **/
  ...
  public APIRedeemAssetsResponse operationMetadata(APIOperationMetadata operationMetadata) {
  ...
  **/
  ...
  public APIRedeemAssetsResponse error(APIReceiptOperationErrorInformation error) {
    this.error = error;
    return this;
  }
  ...
  **/
  ...
  public APIRedeemAssetsResponse response(APIReceipt response) {
