...
public class APIHoldOperationResponse {
  ...
  public APIHoldOperationResponse cid(String cid) {
    this.cid = cid;
    return this;
  }
  ...
  **/
  ...
  public APIHoldOperationResponse isCompleted(Boolean isCompleted) {
  ...
  **/
  ...
  public APIHoldOperationResponse operationMetadata(APIOperationMetadata operationMetadata) {
  ...
  **/
  ...
  public APIHoldOperationResponse error(APIReceiptOperationErrorInformation error) {
    this.error = error;
    return this;
  }
  ...
  **/
  ...
  public APIHoldOperationResponse response(APIReceipt response) {
