...
public class APIGetReceiptResponse {
  ...
  public APIGetReceiptResponse cid(String cid) {
    this.cid = cid;
    return this;
  }
  ...
  **/
  ...
  public APIGetReceiptResponse isCompleted(Boolean isCompleted) {
  ...
  **/
  ...
  public APIGetReceiptResponse operationMetadata(APIOperationMetadata operationMetadata) {
  ...
  **/
  ...
  public APIGetReceiptResponse error(APIReceiptOperationErrorInformation error) {
    this.error = error;
    return this;
  }
  ...
  **/
  ...
  public APIGetReceiptResponse response(APIReceipt response) {
