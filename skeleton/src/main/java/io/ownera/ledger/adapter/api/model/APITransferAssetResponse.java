...
public class APITransferAssetResponse {
  ...
  public APITransferAssetResponse cid(String cid) {
    this.cid = cid;
    return this;
  }
  ...
  **/
  ...
  public APITransferAssetResponse isCompleted(Boolean isCompleted) {
  ...
  **/
  ...
  public APITransferAssetResponse operationMetadata(APIOperationMetadata operationMetadata) {
  ...
  **/
  ...
  public APITransferAssetResponse error(APIReceiptOperationErrorInformation error) {
    this.error = error;
    return this;
  }
  ...
  **/
  ...
  public APITransferAssetResponse response(APIReceipt response) {
