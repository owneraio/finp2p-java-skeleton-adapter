...
public class APIReceiptOperation {
  ...
  public APIReceiptOperation cid(String cid) {
    this.cid = cid;
    return this;
  }
  ...
  **/
  ...
  public APIReceiptOperation isCompleted(Boolean isCompleted) {
  ...
  **/
  ...
  public APIReceiptOperation operationMetadata(APIOperationMetadata operationMetadata) {
  ...
  **/
  ...
  public APIReceiptOperation error(APIReceiptOperationErrorInformation error) {
    this.error = error;
    return this;
  }
  ...
  **/
  ...
  public APIReceiptOperation response(APIReceipt response) {
