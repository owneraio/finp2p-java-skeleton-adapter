...
public class APICreateAssetOperation {
  ...
  public APICreateAssetOperation cid(String cid) {
    this.cid = cid;
    return this;
  }
  ...
  **/
  ...
  public APICreateAssetOperation isCompleted(Boolean isCompleted) {
  ...
  **/
  ...
  public APICreateAssetOperation operationMetadata(APIOperationMetadata operationMetadata) {
  ...
  **/
  ...
  public APICreateAssetOperation error(APICreateAssetOperationErrorInformation error) {
    this.error = error;
    return this;
  }
  ...
  **/
  ...
  public APICreateAssetOperation response(APIAssetCreateResponse response) {
