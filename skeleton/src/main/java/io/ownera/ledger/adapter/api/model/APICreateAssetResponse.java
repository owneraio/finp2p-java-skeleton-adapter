...
public class APICreateAssetResponse {
  ...
  public APICreateAssetResponse cid(String cid) {
    this.cid = cid;
    return this;
  }
  ...
  **/
  ...
  public APICreateAssetResponse isCompleted(Boolean isCompleted) {
  ...
  **/
  ...
  public APICreateAssetResponse operationMetadata(APIOperationMetadata operationMetadata) {
  ...
  **/
  ...
  public APICreateAssetResponse error(APICreateAssetOperationErrorInformation error) {
    this.error = error;
    return this;
  }
  ...
  **/
  ...
  public APICreateAssetResponse response(APIAssetCreateResponse response) {
