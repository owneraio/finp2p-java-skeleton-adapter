...
public class APIIssueAssetsResponse {
  ...
  public APIIssueAssetsResponse cid(String cid) {
    this.cid = cid;
    return this;
  }
  ...
  **/
  ...
  public APIIssueAssetsResponse isCompleted(Boolean isCompleted) {
  ...
  **/
  ...
  public APIIssueAssetsResponse operationMetadata(APIOperationMetadata operationMetadata) {
  ...
  **/
  ...
  public APIIssueAssetsResponse error(APIReceiptOperationErrorInformation error) {
    this.error = error;
    return this;
  }
  ...
  **/
  ...
  public APIIssueAssetsResponse response(APIReceipt response) {
