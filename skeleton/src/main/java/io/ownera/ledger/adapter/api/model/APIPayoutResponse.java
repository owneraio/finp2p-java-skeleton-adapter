...
public class APIPayoutResponse {
  ...
  public APIPayoutResponse cid(String cid) {
    this.cid = cid;
    return this;
  }
  ...
  **/
  ...
  public APIPayoutResponse isCompleted(Boolean isCompleted) {
  ...
  **/
  ...
  public APIPayoutResponse operationMetadata(APIOperationMetadata operationMetadata) {
  ...
  **/
  ...
  public APIPayoutResponse error(APIReceiptOperationErrorInformation error) {
    this.error = error;
    return this;
  }
  ...
  **/
  ...
  public APIPayoutResponse response(APIReceipt response) {
