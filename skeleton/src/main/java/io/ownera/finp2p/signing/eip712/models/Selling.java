...
public class Selling extends Buying {

    public static final String TYPE_NAME = "Selling";
    ...
    public Selling(String nonce, FinId buyer, FinId seller, Term asset, Term settlement) {
