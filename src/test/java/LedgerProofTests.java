...
import io.ownera.ledger.adapter.service.proof.ProofProviderException;
...
public class LedgerProofTests {
    ...
    @Test
    public void calculateProof() throws JsonProcessingException {
        ...
        System.out.println(MAPPER.
                ...
                writeValueAsString(toAPI(receipt)));
    }
}
