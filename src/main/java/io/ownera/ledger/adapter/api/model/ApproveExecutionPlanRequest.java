...
public class ApproveExecutionPlanRequest {
  ...
  public ApproveExecutionPlanRequest executionPlan(@javax.annotation.Nonnull ApproveExecutionPlanRequestExecutionPlan executionPlan) {
  ...
  @JsonProperty(value = JSON_PROPERTY_EXECUTION_PLAN, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setExecutionPlan(@javax.annotation.Nonnull ApproveExecutionPlanRequestExecutionPlan executionPlan) {
    this.executionPlan = executionPlan;
  }
