...
public enum APIAssetDenominationType {
  ...
  APIAssetDenominationType(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static APIAssetDenominationType fromValue(String value) {
    for (APIAssetDenominationType b : APIAssetDenominationType.values()) {
