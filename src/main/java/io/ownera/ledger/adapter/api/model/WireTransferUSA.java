 ...
 */
@JsonPropertyOrder({
  WireTransferUSA.JSON_PROPERTY_TYPE,
  WireTransferUSA.JSON_PROPERTY_ACCOUNT_NUMBER,
  WireTransferUSA.JSON_PROPERTY_ROUTING_NUMBER,
  WireTransferUSA.JSON_PROPERTY_LINE1,
  WireTransferUSA.JSON_PROPERTY_CITY,
  WireTransferUSA.JSON_PROPERTY_POSTAL_CODE,
  WireTransferUSA.JSON_PROPERTY_COUNTRY,
  WireTransferUSA.JSON_PROPERTY_STATE
})
...
public class WireTransferUSA {
  ...
  public WireTransferUSA() { 
  }

  public WireTransferUSA type(@javax.annotation.Nonnull TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public WireTransferUSA accountNumber(@javax.annotation.Nonnull String accountNumber) {
  ...
  public WireTransferUSA routingNumber(@javax.annotation.Nonnull String routingNumber) {
  ...
  public WireTransferUSA line1(@javax.annotation.Nullable String line1) {
    this.line1 = line1;
    return this;
  }
  ...
  public WireTransferUSA city(@javax.annotation.Nullable String city) {
    this.city = city;
    return this;
  }
  ...
  public WireTransferUSA postalCode(@javax.annotation.Nullable String postalCode) {
  ...
  public WireTransferUSA country(@javax.annotation.Nullable String country) {
  ...
  public WireTransferUSA state(@javax.annotation.Nullable String state) {
    this.state = state;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    WireTransferUSA wireTransferUSA = (WireTransferUSA) o;
  ...
  public String toString() {
    ...
    sb.append("class WireTransferUSA {\n");
