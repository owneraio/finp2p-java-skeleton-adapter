...
import io.ownera.ledger.adapter.api.model.HealthResponseHealth;
 ...
 */
@JsonPropertyOrder({
  HealthCheckOperation.JSON_PROPERTY_CID,
  HealthCheckOperation.JSON_PROPERTY_IS_COMPLETED,
  HealthCheckOperation.JSON_PROPERTY_OPERATION_METADATA,
  HealthCheckOperation.JSON_PROPERTY_HEALTH
})
...
public class HealthCheckOperation {
  ...
  @javax.annotation.Nonnull
  private HealthResponseHealth health;

  public HealthCheckOperation() { 
  }

  public HealthCheckOperation cid(@javax.annotation.Nonnull String cid) {
    this.cid = cid;
    return this;
  }
  ...
  public HealthCheckOperation isCompleted(@javax.annotation.Nonnull Boolean isCompleted) {
  ...
  public HealthCheckOperation operationMetadata(@javax.annotation.Nullable OperationMetadata operationMetadata) {
  ...
  public HealthCheckOperation health(@javax.annotation.Nonnull HealthResponseHealth health) {
    this.health = health;
    return this;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public HealthResponseHealth getHealth() {
    return health;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_HEALTH, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setHealth(@javax.annotation.Nonnull HealthResponseHealth health) {
    this.health = health;
  }
  ...
  public boolean equals(Object o) {
    ...
    HealthCheckOperation healthCheckOperation = (HealthCheckOperation) o;
  ...
  public String toString() {
    ...
    sb.append("class HealthCheckOperation {\n");
