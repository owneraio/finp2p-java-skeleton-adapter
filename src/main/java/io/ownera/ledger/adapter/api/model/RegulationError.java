...
public class RegulationError {
  ...
  public RegulationError regulationType(@javax.annotation.Nonnull String regulationType) {
  ...
  public RegulationError details(@javax.annotation.Nonnull String details) {
