 ...
 */
@JsonPropertyOrder({
  APIAPIError.JSON_PROPERTY_CODE,
  APIAPIError.JSON_PROPERTY_MESSAGE
})
...
public class APIAPIError {
  ...
  public APIAPIError code(@javax.annotation.Nonnull Integer code) {
    this.code = code;
    return this;
  }
  ...
  public APIAPIError message(@javax.annotation.Nonnull String message) {
