 ...
 */
@JsonPropertyOrder({
  PlanApproved.JSON_PROPERTY_STATUS
})
...
public class PlanApproved {
  ...
  public PlanApproved status(@javax.annotation.Nonnull StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    PlanApproved planApproved = (PlanApproved) o;
