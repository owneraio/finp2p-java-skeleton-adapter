...
public class APIExecutionContext {
  ...
  public APIExecutionContext executionPlanId(@javax.annotation.Nonnull String executionPlanId) {
  ...
  public APIExecutionContext instructionSequenceNumber(@javax.annotation.Nonnull Integer instructionSequenceNumber) {
