 ...
 */
@JsonPropertyOrder({
  CustomError.JSON_PROPERTY_CODE,
  CustomError.JSON_PROPERTY_MESSAGE
})
...
public class CustomError {
  ...
  public CustomError code(@javax.annotation.Nonnull Integer code) {
    this.code = code;
    return this;
  }
  ...
  public CustomError message(@javax.annotation.Nonnull String message) {
