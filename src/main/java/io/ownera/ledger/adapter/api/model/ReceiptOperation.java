...
public class ReceiptOperation {
  ...
  public ReceiptOperation cid(String cid) {
    this.cid = cid;
    return this;
  }
  ...
  public ReceiptOperation isCompleted(Boolean isCompleted) {
  ...
  public ReceiptOperation error(ReceiptOperationErrorInformation error) {
    this.error = error;
    return this;
  }
  ...
  public ReceiptOperation response(Receipt response) {
