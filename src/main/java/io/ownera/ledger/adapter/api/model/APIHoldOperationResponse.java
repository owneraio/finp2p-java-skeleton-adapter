...
/**
 * APIHoldOperationResponse
 */
@JsonPropertyOrder({
  APIHoldOperationResponse.JSON_PROPERTY_CID,
  APIHoldOperationResponse.JSON_PROPERTY_IS_COMPLETED,
  APIHoldOperationResponse.JSON_PROPERTY_OPERATION_METADATA,
  APIHoldOperationResponse.JSON_PROPERTY_ERROR,
  APIHoldOperationResponse.JSON_PROPERTY_RESPONSE
})
...
public class APIHoldOperationResponse {
  ...
  public APIHoldOperationResponse() { 
  }

  public APIHoldOperationResponse cid(@javax.annotation.Nonnull String cid) {
    this.cid = cid;
    return this;
  }
  ...
  public APIHoldOperationResponse isCompleted(@javax.annotation.Nonnull Boolean isCompleted) {
  ...
  public APIHoldOperationResponse operationMetadata(@javax.annotation.Nullable APIOperationMetadata operationMetadata) {
  ...
  public APIHoldOperationResponse error(@javax.annotation.Nullable APIReceiptOperationErrorInformation error) {
    this.error = error;
    return this;
  }
  ...
  public APIHoldOperationResponse response(@javax.annotation.Nullable APIReceipt response) {
  ...
  /**
   * Return true if this HoldOperationResponse object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    APIHoldOperationResponse holdOperationResponse = (APIHoldOperationResponse) o;
    return Objects.equals(this.cid, holdOperationResponse.cid) &&
        Objects.equals(this.isCompleted, holdOperationResponse.isCompleted) &&
        Objects.equals(this.operationMetadata, holdOperationResponse.operationMetadata) &&
        Objects.equals(this.error, holdOperationResponse.error) &&
        Objects.equals(this.response, holdOperationResponse.response);
  }
  ...
  public String toString() {
    ...
    sb.append("class APIHoldOperationResponse {\n");
