 ...
 */
@JsonPropertyOrder({
  SortCodeDetails.JSON_PROPERTY_TYPE,
  SortCodeDetails.JSON_PROPERTY_CODE,
  SortCodeDetails.JSON_PROPERTY_ACCOUNT_NUMBER
})
...
public class SortCodeDetails {
  ...
  public SortCodeDetails() { 
  }

  public SortCodeDetails type(@javax.annotation.Nonnull TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public SortCodeDetails code(@javax.annotation.Nonnull String code) {
    this.code = code;
    return this;
  }
  ...
  public SortCodeDetails accountNumber(@javax.annotation.Nonnull String accountNumber) {
  ...
  public boolean equals(Object o) {
    ...
    SortCodeDetails sortCodeDetails = (SortCodeDetails) o;
  ...
  public String toString() {
    ...
    sb.append("class SortCodeDetails {\n");
