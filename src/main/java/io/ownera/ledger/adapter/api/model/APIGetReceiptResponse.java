...
/**
 * APIGetReceiptResponse
 */
@JsonPropertyOrder({
  APIGetReceiptResponse.JSON_PROPERTY_CID,
  APIGetReceiptResponse.JSON_PROPERTY_IS_COMPLETED,
  APIGetReceiptResponse.JSON_PROPERTY_OPERATION_METADATA,
  APIGetReceiptResponse.JSON_PROPERTY_ERROR,
  APIGetReceiptResponse.JSON_PROPERTY_RESPONSE
})
...
public class APIGetReceiptResponse {
  ...
  public APIGetReceiptResponse() { 
  }

  public APIGetReceiptResponse cid(@javax.annotation.Nonnull String cid) {
    this.cid = cid;
    return this;
  }
  ...
  public APIGetReceiptResponse isCompleted(@javax.annotation.Nonnull Boolean isCompleted) {
  ...
  public APIGetReceiptResponse operationMetadata(@javax.annotation.Nullable APIOperationMetadata operationMetadata) {
  ...
  public APIGetReceiptResponse error(@javax.annotation.Nullable APIReceiptOperationErrorInformation error) {
    this.error = error;
    return this;
  }
  ...
  public APIGetReceiptResponse response(@javax.annotation.Nullable APIReceipt response) {
  ...
  /**
   * Return true if this GetReceiptResponse object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    APIGetReceiptResponse getReceiptResponse = (APIGetReceiptResponse) o;
    return Objects.equals(this.cid, getReceiptResponse.cid) &&
        Objects.equals(this.isCompleted, getReceiptResponse.isCompleted) &&
        Objects.equals(this.operationMetadata, getReceiptResponse.operationMetadata) &&
        Objects.equals(this.error, getReceiptResponse.error) &&
        Objects.equals(this.response, getReceiptResponse.response);
  }
  ...
  public String toString() {
    ...
    sb.append("class APIGetReceiptResponse {\n");
