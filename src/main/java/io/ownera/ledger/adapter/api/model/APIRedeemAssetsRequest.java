...
@JsonPropertyOrder({
  ...
  APIRedeemAssetsRequest.JSON_PROPERTY_ASSET,
...
public class APIRedeemAssetsRequest {
  ...
  @javax.annotation.Nonnull
  private APIFinIdAccount source;
  ...
  public APIRedeemAssetsRequest nonce(@javax.annotation.Nonnull String nonce) {
    this.nonce = nonce;
    return this;
  }
  ...
  public APIRedeemAssetsRequest operationId(@javax.annotation.Nullable String operationId) {
  ...
  public APIRedeemAssetsRequest source(@javax.annotation.Nonnull APIFinIdAccount source) {
    this.source = source;
    return this;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public APIFinIdAccount getSource() {
    return source;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_SOURCE, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setSource(@javax.annotation.Nonnull APIFinIdAccount source) {
    this.source = source;
  }


  public APIRedeemAssetsRequest quantity(@javax.annotation.Nonnull String quantity) {
  ...
  public APIRedeemAssetsRequest asset(@javax.annotation.Nonnull APIFinp2pAsset asset) {
    this.asset = asset;
    return this;
  }
  ...
  public APIRedeemAssetsRequest settlementRef(@javax.annotation.Nonnull String settlementRef) {
  ...
  public APIRedeemAssetsRequest signature(@javax.annotation.Nonnull APISignature signature) {
  ...
  public APIRedeemAssetsRequest executionContext(@javax.annotation.Nullable APIExecutionContext executionContext) {
