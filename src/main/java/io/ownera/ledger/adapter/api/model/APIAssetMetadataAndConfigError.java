...
/**
 * APIAssetMetadataAndConfigError
 */
@JsonPropertyOrder({
  APIAssetMetadataAndConfigError.JSON_PROPERTY_CODE,
  APIAssetMetadataAndConfigError.JSON_PROPERTY_MESSAGE
})
...
public class APIAssetMetadataAndConfigError {
  /**
   * Gets or Sets code
   */
  public enum CodeEnum {
    NUMBER_4108(Integer.valueOf(4108));
  ...
  public enum MessageEnum {
    ASSET_METADATA_AND_CONFIG_CANNOT_BE_PROVIDED_AT_THE_SAME_TIME(String.valueOf("Asset metadata and config cannot be provided at the same time"));
  ...
  public APIAssetMetadataAndConfigError() { 
  }

  public APIAssetMetadataAndConfigError code(@javax.annotation.Nonnull CodeEnum code) {
    this.code = code;
    return this;
  }
  ...
  public APIAssetMetadataAndConfigError message(@javax.annotation.Nonnull MessageEnum message) {
  ...
  /**
   * Return true if this AssetMetadataAndConfigError object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    APIAssetMetadataAndConfigError assetMetadataAndConfigError = (APIAssetMetadataAndConfigError) o;
    return Objects.equals(this.code, assetMetadataAndConfigError.code) &&
        Objects.equals(this.message, assetMetadataAndConfigError.message);
  }
  ...
  public String toString() {
    ...
    sb.append("class APIAssetMetadataAndConfigError {\n");
