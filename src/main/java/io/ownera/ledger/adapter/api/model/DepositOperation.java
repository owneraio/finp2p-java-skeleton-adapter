 ...
 */
@JsonPropertyOrder({
  DepositOperation.JSON_PROPERTY_CID,
  DepositOperation.JSON_PROPERTY_IS_COMPLETED,
  DepositOperation.JSON_PROPERTY_OPERATION_METADATA,
  DepositOperation.JSON_PROPERTY_ERROR,
  DepositOperation.JSON_PROPERTY_RESPONSE
})
...
public class DepositOperation {
  ...
  public DepositOperation cid(@javax.annotation.Nonnull String cid) {
    this.cid = cid;
    return this;
  }
  ...
  public DepositOperation isCompleted(@javax.annotation.Nonnull Boolean isCompleted) {
  ...
  public DepositOperation operationMetadata(@javax.annotation.Nullable OperationMetadata operationMetadata) {
  ...
  public DepositOperation error(@javax.annotation.Nullable Object error) {
    this.error = error;
    return this;
  }
  ...
  public DepositOperation response(@javax.annotation.Nullable DepositInstruction response) {
  ...
  /**
   * Return true if this depositOperation object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    DepositOperation depositOperation = (DepositOperation) o;
    return Objects.equals(this.cid, depositOperation.cid) &&
        Objects.equals(this.isCompleted, depositOperation.isCompleted) &&
        Objects.equals(this.operationMetadata, depositOperation.operationMetadata) &&
        Objects.equals(this.error, depositOperation.error) &&
        Objects.equals(this.response, depositOperation.response);
  }
  ...
  public String toString() {
    ...
    sb.append("class DepositOperation {\n");
