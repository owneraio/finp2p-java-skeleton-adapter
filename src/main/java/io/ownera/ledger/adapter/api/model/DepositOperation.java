...
public class DepositOperation {
  ...
  public DepositOperation cid(String cid) {
    this.cid = cid;
    return this;
  }
  ...
  public DepositOperation isCompleted(Boolean isCompleted) {
  ...
  public DepositOperation error(Object error) {
    this.error = error;
    return this;
  }
  ...
  public DepositOperation response(DepositInstruction response) {
