...
/**
 * APIReleaseOperationResponse
 */
@JsonPropertyOrder({
  APIReleaseOperationResponse.JSON_PROPERTY_CID,
  APIReleaseOperationResponse.JSON_PROPERTY_IS_COMPLETED,
  APIReleaseOperationResponse.JSON_PROPERTY_OPERATION_METADATA,
  APIReleaseOperationResponse.JSON_PROPERTY_ERROR,
  APIReleaseOperationResponse.JSON_PROPERTY_RESPONSE
})
...
public class APIReleaseOperationResponse {
  ...
  public APIReleaseOperationResponse() { 
  }

  public APIReleaseOperationResponse cid(@javax.annotation.Nonnull String cid) {
    this.cid = cid;
    return this;
  }
  ...
  public APIReleaseOperationResponse isCompleted(@javax.annotation.Nonnull Boolean isCompleted) {
  ...
  public APIReleaseOperationResponse operationMetadata(@javax.annotation.Nullable APIOperationMetadata operationMetadata) {
  ...
  public APIReleaseOperationResponse error(@javax.annotation.Nullable APIReceiptOperationErrorInformation error) {
    this.error = error;
    return this;
  }
  ...
  public APIReleaseOperationResponse response(@javax.annotation.Nullable APIReceipt response) {
  ...
  /**
   * Return true if this ReleaseOperationResponse object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    APIReleaseOperationResponse releaseOperationResponse = (APIReleaseOperationResponse) o;
    return Objects.equals(this.cid, releaseOperationResponse.cid) &&
        Objects.equals(this.isCompleted, releaseOperationResponse.isCompleted) &&
        Objects.equals(this.operationMetadata, releaseOperationResponse.operationMetadata) &&
        Objects.equals(this.error, releaseOperationResponse.error) &&
        Objects.equals(this.response, releaseOperationResponse.response);
  }
  ...
  public String toString() {
    ...
    sb.append("class APIReleaseOperationResponse {\n");
