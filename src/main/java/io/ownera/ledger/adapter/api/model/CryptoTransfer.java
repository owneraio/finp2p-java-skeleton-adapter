 ...
 */
@JsonPropertyOrder({
  CryptoTransfer.JSON_PROPERTY_TYPE,
  CryptoTransfer.JSON_PROPERTY_NETWORK,
  CryptoTransfer.JSON_PROPERTY_CONTRACT_ADDRESS,
  CryptoTransfer.JSON_PROPERTY_WALLET_ADDRESS
})
...
public class CryptoTransfer {
  ...
  public CryptoTransfer type(@javax.annotation.Nonnull TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public CryptoTransfer network(@javax.annotation.Nonnull String network) {
  ...
  public CryptoTransfer contractAddress(@javax.annotation.Nonnull String contractAddress) {
  ...
  public CryptoTransfer walletAddress(@javax.annotation.Nonnull String walletAddress) {
