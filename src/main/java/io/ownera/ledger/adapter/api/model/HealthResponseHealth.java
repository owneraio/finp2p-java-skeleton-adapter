 ...
 */
@JsonPropertyOrder({
  HealthResponseHealth.JSON_PROPERTY_STATUS
})
...
public class HealthResponseHealth {
  ...
  public HealthResponseHealth status(@javax.annotation.Nonnull String status) {
    this.status = status;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    HealthResponseHealth healthResponseHealth = (HealthResponseHealth) o;
  ...
  public String toString() {
    ...
    sb.append("class HealthResponseHealth {\n");
