...
/**
 * APITransferAssetResponse
 */
@JsonPropertyOrder({
  APITransferAssetResponse.JSON_PROPERTY_CID,
  APITransferAssetResponse.JSON_PROPERTY_IS_COMPLETED,
  APITransferAssetResponse.JSON_PROPERTY_OPERATION_METADATA,
  APITransferAssetResponse.JSON_PROPERTY_ERROR,
  APITransferAssetResponse.JSON_PROPERTY_RESPONSE
})
...
public class APITransferAssetResponse {
  ...
  public APITransferAssetResponse() { 
  }

  public APITransferAssetResponse cid(@javax.annotation.Nonnull String cid) {
    this.cid = cid;
    return this;
  }
  ...
  public APITransferAssetResponse isCompleted(@javax.annotation.Nonnull Boolean isCompleted) {
  ...
  public APITransferAssetResponse operationMetadata(@javax.annotation.Nullable APIOperationMetadata operationMetadata) {
  ...
  public APITransferAssetResponse error(@javax.annotation.Nullable APIReceiptOperationErrorInformation error) {
    this.error = error;
    return this;
  }
  ...
  public APITransferAssetResponse response(@javax.annotation.Nullable APIReceipt response) {
  ...
  /**
   * Return true if this TransferAssetResponse object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    APITransferAssetResponse transferAssetResponse = (APITransferAssetResponse) o;
    return Objects.equals(this.cid, transferAssetResponse.cid) &&
        Objects.equals(this.isCompleted, transferAssetResponse.isCompleted) &&
        Objects.equals(this.operationMetadata, transferAssetResponse.operationMetadata) &&
        Objects.equals(this.error, transferAssetResponse.error) &&
        Objects.equals(this.response, transferAssetResponse.response);
  }
  ...
  public String toString() {
    ...
    sb.append("class APITransferAssetResponse {\n");
