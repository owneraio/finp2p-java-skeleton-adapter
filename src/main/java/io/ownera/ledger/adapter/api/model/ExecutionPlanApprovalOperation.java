...
import io.ownera.ledger.adapter.api.model.PlanApprovalResponseApproval;
 ...
 */
@JsonPropertyOrder({
  ExecutionPlanApprovalOperation.JSON_PROPERTY_CID,
  ExecutionPlanApprovalOperation.JSON_PROPERTY_IS_COMPLETED,
  ExecutionPlanApprovalOperation.JSON_PROPERTY_OPERATION_METADATA,
  ExecutionPlanApprovalOperation.JSON_PROPERTY_APPROVAL
})
...
public class ExecutionPlanApprovalOperation {
  ...
  @javax.annotation.Nullable
  private PlanApprovalResponseApproval approval;

  public ExecutionPlanApprovalOperation() { 
  }

  public ExecutionPlanApprovalOperation cid(@javax.annotation.Nonnull String cid) {
    this.cid = cid;
    return this;
  }
  ...
  public ExecutionPlanApprovalOperation isCompleted(@javax.annotation.Nonnull Boolean isCompleted) {
  ...
  public ExecutionPlanApprovalOperation operationMetadata(@javax.annotation.Nullable OperationMetadata operationMetadata) {
  ...
  public ExecutionPlanApprovalOperation approval(@javax.annotation.Nullable PlanApprovalResponseApproval approval) {
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public PlanApprovalResponseApproval getApproval() {
    return approval;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_APPROVAL, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setApproval(@javax.annotation.Nullable PlanApprovalResponseApproval approval) {
    this.approval = approval;
  }


  /**
   * Return true if this ExecutionPlanApprovalOperation object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    ExecutionPlanApprovalOperation executionPlanApprovalOperation = (ExecutionPlanApprovalOperation) o;
    return Objects.equals(this.cid, executionPlanApprovalOperation.cid) &&
        Objects.equals(this.isCompleted, executionPlanApprovalOperation.isCompleted) &&
        Objects.equals(this.operationMetadata, executionPlanApprovalOperation.operationMetadata) &&
        Objects.equals(this.approval, executionPlanApprovalOperation.approval);
  }

  @Override
  public int hashCode() {
    return Objects.hash(cid, isCompleted, operationMetadata, approval);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ExecutionPlanApprovalOperation {\n");
