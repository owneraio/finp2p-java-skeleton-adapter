...
/**
 * APIDepositInstructionResponse
 */
@JsonPropertyOrder({
  APIDepositInstructionResponse.JSON_PROPERTY_CID,
  APIDepositInstructionResponse.JSON_PROPERTY_IS_COMPLETED,
  APIDepositInstructionResponse.JSON_PROPERTY_OPERATION_METADATA,
...
public class APIDepositInstructionResponse {
  ...
  public APIDepositInstructionResponse() { 
  }

  public APIDepositInstructionResponse cid(@javax.annotation.Nonnull String cid) {
    this.cid = cid;
    return this;
  }
  ...
  public APIDepositInstructionResponse isCompleted(@javax.annotation.Nonnull Boolean isCompleted) {
  ...
  public APIDepositInstructionResponse operationMetadata(@javax.annotation.Nullable APIOperationMetadata operationMetadata) {
  ...
  public APIDepositInstructionResponse error(@javax.annotation.Nullable Object error) {
    this.error = error;
    return this;
  }
  ...
  public APIDepositInstructionResponse response(@javax.annotation.Nullable APIDepositInstruction response) {
  ...
  public boolean equals(Object o) {
    ...
    APIDepositInstructionResponse depositInstructionResponse = (APIDepositInstructionResponse) o;
  ...
  public String toString() {
    ...
    sb.append("class APIDepositInstructionResponse {\n");
