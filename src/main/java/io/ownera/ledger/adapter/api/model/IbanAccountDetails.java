 ...
 */
@JsonPropertyOrder({
  IbanAccountDetails.JSON_PROPERTY_TYPE,
  IbanAccountDetails.JSON_PROPERTY_IBAN
})
...
public class IbanAccountDetails {
  /**
   * Gets or Sets type
   */
  ...
  public IbanAccountDetails() { 
  }

  public IbanAccountDetails type(@javax.annotation.Nonnull TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public IbanAccountDetails iban(@javax.annotation.Nonnull String iban) {
    this.iban = iban;
    return this;
  }
  ...
  /**
   * Return true if this ibanAccountDetails object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    IbanAccountDetails ibanAccountDetails = (IbanAccountDetails) o;
    return Objects.equals(this.type, ibanAccountDetails.type) &&
        Objects.equals(this.iban, ibanAccountDetails.iban);
  }
  ...
  public String toString() {
    ...
    sb.append("class IbanAccountDetails {\n");
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getIban() != null) {
      joiner.add(String.format(Locale.ROOT, "%siban%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getIban()))));
    }
