...
public class RollbackOperationResponse {
  ...
  public RollbackOperationResponse cid(String cid) {
    this.cid = cid;
    return this;
  }
  ...
  public RollbackOperationResponse isCompleted(Boolean isCompleted) {
  ...
  public RollbackOperationResponse error(ReceiptOperationErrorInformation error) {
    this.error = error;
    return this;
  }
  ...
  public RollbackOperationResponse response(Receipt response) {
