...
/**
 * APICreateAssetOperation
 */
@JsonPropertyOrder({
  APICreateAssetOperation.JSON_PROPERTY_CID,
  APICreateAssetOperation.JSON_PROPERTY_IS_COMPLETED,
  APICreateAssetOperation.JSON_PROPERTY_OPERATION_METADATA,
  APICreateAssetOperation.JSON_PROPERTY_ERROR,
  APICreateAssetOperation.JSON_PROPERTY_RESPONSE
})
...
public class APICreateAssetOperation {
  ...
  public APICreateAssetOperation() { 
  }

  public APICreateAssetOperation cid(@javax.annotation.Nonnull String cid) {
    this.cid = cid;
    return this;
  }
  ...
  public APICreateAssetOperation isCompleted(@javax.annotation.Nonnull Boolean isCompleted) {
  ...
  public APICreateAssetOperation operationMetadata(@javax.annotation.Nullable APIOperationMetadata operationMetadata) {
  ...
  public APICreateAssetOperation error(@javax.annotation.Nullable APICreateAssetOperationErrorInformation error) {
    this.error = error;
    return this;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_ERROR, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setError(@javax.annotation.Nullable APICreateAssetOperationErrorInformation error) {
    this.error = error;
  }


  public APICreateAssetOperation response(@javax.annotation.Nullable APIAssetCreateResponse response) {
  ...
  @JsonProperty(value = JSON_PROPERTY_RESPONSE, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable APIAssetCreateResponse response) {
    this.response = response;
  }


  /**
   * Return true if this createAssetOperation object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    APICreateAssetOperation createAssetOperation = (APICreateAssetOperation) o;
    return Objects.equals(this.cid, createAssetOperation.cid) &&
        Objects.equals(this.isCompleted, createAssetOperation.isCompleted) &&
        Objects.equals(this.operationMetadata, createAssetOperation.operationMetadata) &&
        Objects.equals(this.error, createAssetOperation.error) &&
        Objects.equals(this.response, createAssetOperation.response);
  }
  ...
  public String toString() {
    ...
    sb.append("class APICreateAssetOperation {\n");
