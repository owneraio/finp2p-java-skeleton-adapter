 ...
 */
@JsonPropertyOrder({
  OperationStatusDeposit.JSON_PROPERTY_TYPE,
  OperationStatusDeposit.JSON_PROPERTY_OPERATION
})
...
public class OperationStatusDeposit {
  /**
   * Gets or Sets type
   */
  ...
  public OperationStatusDeposit() { 
  }

  public OperationStatusDeposit type(@javax.annotation.Nonnull TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public OperationStatusDeposit operation(@javax.annotation.Nonnull DepositOperation operation) {
  ...
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public DepositOperation getOperation() {
    return operation;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_OPERATION, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setOperation(@javax.annotation.Nonnull DepositOperation operation) {
    this.operation = operation;
  }
  ...
  public boolean equals(Object o) {
    ...
    OperationStatusDeposit operationStatusDeposit = (OperationStatusDeposit) o;
  ...
  public String toString() {
    ...
    sb.append("class OperationStatusDeposit {\n");
