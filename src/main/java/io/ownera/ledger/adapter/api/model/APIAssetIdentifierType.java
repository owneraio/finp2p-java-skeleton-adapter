 ...
 */
public enum APIAssetIdentifierType {
  ...
  APIAssetIdentifierType(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static APIAssetIdentifierType fromValue(String value) {
    for (APIAssetIdentifierType b : APIAssetIdentifierType.values()) {
