 ...
 */
@JsonPropertyOrder({
  RedeemAssetsResponse.JSON_PROPERTY_CID,
  RedeemAssetsResponse.JSON_PROPERTY_IS_COMPLETED,
  RedeemAssetsResponse.JSON_PROPERTY_OPERATION_METADATA,
  RedeemAssetsResponse.JSON_PROPERTY_ERROR,
  RedeemAssetsResponse.JSON_PROPERTY_RESPONSE
})
...
public class RedeemAssetsResponse {
  ...
  public RedeemAssetsResponse() { 
  }

  public RedeemAssetsResponse cid(@javax.annotation.Nonnull String cid) {
    this.cid = cid;
    return this;
  }
  ...
  public RedeemAssetsResponse isCompleted(@javax.annotation.Nonnull Boolean isCompleted) {
  ...
  public RedeemAssetsResponse operationMetadata(@javax.annotation.Nullable OperationMetadata operationMetadata) {
  ...
  public RedeemAssetsResponse error(@javax.annotation.Nullable ReceiptOperationErrorInformation error) {
    this.error = error;
    return this;
  }
  ...
  public RedeemAssetsResponse response(@javax.annotation.Nullable Receipt response) {
  ...
  public boolean equals(Object o) {
    ...
    RedeemAssetsResponse redeemAssetsResponse = (RedeemAssetsResponse) o;
  ...
  public String toString() {
    ...
    sb.append("class RedeemAssetsResponse {\n");
