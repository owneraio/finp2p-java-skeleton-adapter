...
public class RedeemAssetsResponse {
  ...
  public RedeemAssetsResponse cid(String cid) {
    this.cid = cid;
    return this;
  }
  ...
  public RedeemAssetsResponse isCompleted(Boolean isCompleted) {
  ...
  public RedeemAssetsResponse error(ReceiptOperationErrorInformation error) {
    this.error = error;
    return this;
  }
  ...
  public RedeemAssetsResponse response(Receipt response) {
