 ...
 */
@JsonPropertyOrder({
  APIPlanApproved.JSON_PROPERTY_STATUS
})
...
public class APIPlanApproved {
  ...
  public APIPlanApproved() { 
  }

  public APIPlanApproved status(@javax.annotation.Nonnull StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  /**
   * Return true if this PlanApproved object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    APIPlanApproved planApproved = (APIPlanApproved) o;
    return Objects.equals(this.status, planApproved.status);
  }
  ...
  public String toString() {
    ...
    sb.append("class APIPlanApproved {\n");
