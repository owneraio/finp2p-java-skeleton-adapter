 ...
 */
@JsonPropertyOrder({
  FiatAsset.JSON_PROPERTY_TYPE,
  FiatAsset.JSON_PROPERTY_CODE
})
...
public class FiatAsset {
  ...
  public FiatAsset type(@javax.annotation.Nonnull TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public FiatAsset code(@javax.annotation.Nonnull String code) {
    this.code = code;
    return this;
  }
