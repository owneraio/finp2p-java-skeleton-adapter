...
public class EIP712TypedValue extends AbstractOpenApiSchema {
    ...
    public static class EIP712TypedValueDeserializer extends StdDeserializer<EIP712TypedValue> {
        ...
        public EIP712TypedValue deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            // deserialize Map<String, EIP712TypedValue>
//            try {
//                boolean attemptParsing = true;
//                // ensure that we respect type coercion as set on the client ObjectMapper
//                if (Map<String, EIP712TypedValue>.class.equals(Integer.class) || Map<String, EIP712TypedValue>.class.equals(Long.class) || Map<String, EIP712TypedValue>.class.equals(Float.class) || Map<String, EIP712TypedValue>.class.equals(Double.class) || Map<String, EIP712TypedValue>.class.equals(Boolean.class) || Map<String, EIP712TypedValue>.class.equals(String.class)) {
//                    attemptParsing = typeCoercion;
//                    if (!attemptParsing) {
//                        attemptParsing |= ((Map<String, EIP712TypedValue>.class.equals(Integer.class) || Map<String, EIP712TypedValue>.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
//                        attemptParsing |= ((Map<String, EIP712TypedValue>.class.equals(Float.class) || Map<String, EIP712TypedValue>.class.equals(Double.class)) && token == JsonToken.VALUE_NUMBER_FLOAT);
//                        attemptParsing |= (Map<String, EIP712TypedValue>.class.equals(Boolean.class) && (token == JsonToken.VALUE_FALSE || token == JsonToken.VALUE_TRUE));
//                        attemptParsing |= (Map<String, EIP712TypedValue>.class.equals(String.class) && token == JsonToken.VALUE_STRING);
//                    }
//                }
//                if (attemptParsing) {
//                    deserialized = tree.traverse(jp.getCodec()).readValueAs(Map<String, EIP712TypedValue>.class);
//                    // TODO: there is no validation against JSON schema constraints
//                    // (min, max, enum, pattern...), this does not perform a strict JSON
//                    // validation, which means the 'match' count may be higher than it should be.
//                    match++;
//                    log.log(Level.FINER, "Input data matches schema 'Map<String, EIP712TypedValue>'");
//                }
//            } catch (Exception e) {
//                // deserialization failed, continue
//                log.log(Level.FINER, "Input data does not match schema 'Map<String, EIP712TypedValue>'", e);
//            }
            ...
            throw new IOException(String.format(Locale.ROOT, "Failed deserialization for EIP712TypedValue: %d classes match result, expected 1", match));
        }
    ...
    public EIP712TypedValue(Map<String, EIP712TypedValue> o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
...
//        schemas.put("Map<String, EIP712TypedValue>", Map<String, EIP712TypedValue>.class);
     ...
     * Boolean, Integer, Map<String, EIP712TypedValue>, String
     *
...
//        if (JSON.isInstanceOf(Map<String, EIP712TypedValue>.class, instance, new HashSet<Class<?>>())) {
//            super.setActualInstance(instance);
//            return;
//        }
        ...
        throw new RuntimeException("Invalid instance type. Must be Boolean, Integer, Map<String, EIP712TypedValue>, String");
    }
     ...
     * Boolean, Integer, Map<String, EIP712TypedValue>, String
     *
     * @return The actual instance (Boolean, Integer, Map<String, EIP712TypedValue>, String)
     */
    @Override
    ...
    /**
     * Get the actual instance of `Map<String, EIP712TypedValue>`. If the actual instance is not `Map<String, EIP712TypedValue>`,
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `Map<String, EIP712TypedValue>`
     * @throws ClassCastException if the instance is not `Map<String, EIP712TypedValue>`
     */
//    public Map<String, EIP712TypedValue> getMap<String, EIP712TypedValue>() throws ClassCastException {
//        return (Map<String, EIP712TypedValue>)super.getActualInstance();
//    }
...
//    if (getActualInstance() instanceof Map<String, EIP712TypedValue>) {
//        if (getActualInstance() != null) {
//          for (String _key : ((Map<String, EIP712TypedValue>)getActualInstance()).keySet()) {
//            if (((Map<String, EIP712TypedValue>)getActualInstance()).get(_key) != null) {
//              joiner.add(((EIP712TypedValue)getActualInstance()).get(_key).toUrlQueryString(String.format(Locale.ROOT, "%sone_of_4%s%s", prefix, suffix,
