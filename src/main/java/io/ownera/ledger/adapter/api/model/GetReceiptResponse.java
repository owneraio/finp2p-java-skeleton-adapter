...
public class GetReceiptResponse {
  ...
  public GetReceiptResponse cid(String cid) {
    this.cid = cid;
    return this;
  }
  ...
  public GetReceiptResponse isCompleted(Boolean isCompleted) {
  ...
  public GetReceiptResponse error(ReceiptOperationErrorInformation error) {
    this.error = error;
    return this;
  }
  ...
  public GetReceiptResponse response(Receipt response) {
