 ...
 */
@JsonPropertyOrder({
  GetReceiptResponse.JSON_PROPERTY_CID,
  GetReceiptResponse.JSON_PROPERTY_IS_COMPLETED,
  GetReceiptResponse.JSON_PROPERTY_OPERATION_METADATA,
  GetReceiptResponse.JSON_PROPERTY_ERROR,
  GetReceiptResponse.JSON_PROPERTY_RESPONSE
})
...
public class GetReceiptResponse {
  ...
  public GetReceiptResponse cid(@javax.annotation.Nonnull String cid) {
    this.cid = cid;
    return this;
  }
  ...
  public GetReceiptResponse isCompleted(@javax.annotation.Nonnull Boolean isCompleted) {
  ...
  public GetReceiptResponse operationMetadata(@javax.annotation.Nullable OperationMetadata operationMetadata) {
  ...
  public GetReceiptResponse error(@javax.annotation.Nullable ReceiptOperationErrorInformation error) {
    this.error = error;
    return this;
  }
  ...
  public GetReceiptResponse response(@javax.annotation.Nullable Receipt response) {
