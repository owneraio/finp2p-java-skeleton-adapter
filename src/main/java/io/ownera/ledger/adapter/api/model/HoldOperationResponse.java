...
public class HoldOperationResponse {
  ...
  public HoldOperationResponse cid(String cid) {
    this.cid = cid;
    return this;
  }
  ...
  public HoldOperationResponse isCompleted(Boolean isCompleted) {
  ...
  public HoldOperationResponse error(ReceiptOperationErrorInformation error) {
    this.error = error;
    return this;
  }
  ...
  public HoldOperationResponse response(Receipt response) {
