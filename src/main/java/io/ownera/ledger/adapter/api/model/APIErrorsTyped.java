...
import io.ownera.ledger.adapter.api.model.APIError;
 ...
 */
@JsonPropertyOrder({
  APIErrorsTyped.JSON_PROPERTY_TYPE,
  APIErrorsTyped.JSON_PROPERTY_ERRORS
})
...
public class APIErrorsTyped {
  ...
  public APIErrorsTyped() { 
  }

  public APIErrorsTyped type(@javax.annotation.Nonnull TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public APIErrorsTyped errors(@javax.annotation.Nonnull List<APIError> errors) {
    this.errors = errors;
    return this;
  }

  public APIErrorsTyped addErrorsItem(APIError errorsItem) {
    if (this.errors == null) {
  ...
  public boolean equals(Object o) {
    ...
    APIErrorsTyped apIErrorsTyped = (APIErrorsTyped) o;
  ...
  public String toString() {
    ...
    sb.append("class APIErrorsTyped {\n");
