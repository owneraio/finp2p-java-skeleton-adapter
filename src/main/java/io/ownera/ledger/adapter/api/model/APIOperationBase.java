 ...
 */
@JsonPropertyOrder({
  APIOperationBase.JSON_PROPERTY_CID,
  APIOperationBase.JSON_PROPERTY_IS_COMPLETED,
  APIOperationBase.JSON_PROPERTY_OPERATION_METADATA
})
...
public class APIOperationBase {
  ...
  public APIOperationBase cid(@javax.annotation.Nonnull String cid) {
    this.cid = cid;
    return this;
  }
  ...
  public APIOperationBase isCompleted(@javax.annotation.Nonnull Boolean isCompleted) {
  ...
  public APIOperationBase operationMetadata(@javax.annotation.Nullable APIOperationMetadata operationMetadata) {
  ...
  public boolean equals(Object o) {
    ...
    APIOperationBase operationBase = (APIOperationBase) o;
  ...
  public String toString() {
    ...
    sb.append("class APIOperationBase {\n");
