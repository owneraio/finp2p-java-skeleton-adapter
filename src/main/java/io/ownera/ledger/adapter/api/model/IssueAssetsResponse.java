...
@JsonPropertyOrder({
  ...
  IssueAssetsResponse.JSON_PROPERTY_OPERATION_METADATA,
...
public class IssueAssetsResponse {
  ...
  public IssueAssetsResponse cid(@javax.annotation.Nonnull String cid) {
    this.cid = cid;
    return this;
  }
  ...
  public IssueAssetsResponse isCompleted(@javax.annotation.Nonnull Boolean isCompleted) {
  ...
  public IssueAssetsResponse operationMetadata(@javax.annotation.Nullable OperationMetadata operationMetadata) {
  ...
  public IssueAssetsResponse error(@javax.annotation.Nullable ReceiptOperationErrorInformation error) {
    this.error = error;
    return this;
  }
  ...
  public IssueAssetsResponse response(@javax.annotation.Nullable Receipt response) {
