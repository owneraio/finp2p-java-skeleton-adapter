...
import io.ownera.ledger.adapter.api.model.APIHealthResponseHealth;
...
/**
 * APIHealthCheckOperation
 */
@JsonPropertyOrder({
  APIHealthCheckOperation.JSON_PROPERTY_CID,
  APIHealthCheckOperation.JSON_PROPERTY_IS_COMPLETED,
  APIHealthCheckOperation.JSON_PROPERTY_OPERATION_METADATA,
  APIHealthCheckOperation.JSON_PROPERTY_HEALTH
})
...
public class APIHealthCheckOperation {
  ...
  @javax.annotation.Nonnull
  private APIHealthResponseHealth health;

  public APIHealthCheckOperation() { 
  }

  public APIHealthCheckOperation cid(@javax.annotation.Nonnull String cid) {
    this.cid = cid;
    return this;
  }
  ...
  public APIHealthCheckOperation isCompleted(@javax.annotation.Nonnull Boolean isCompleted) {
  ...
  public APIHealthCheckOperation operationMetadata(@javax.annotation.Nullable APIOperationMetadata operationMetadata) {
  ...
  public APIHealthCheckOperation health(@javax.annotation.Nonnull APIHealthResponseHealth health) {
    this.health = health;
    return this;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public APIHealthResponseHealth getHealth() {
    return health;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_HEALTH, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setHealth(@javax.annotation.Nonnull APIHealthResponseHealth health) {
    this.health = health;
  }


  /**
   * Return true if this HealthCheckOperation object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    APIHealthCheckOperation healthCheckOperation = (APIHealthCheckOperation) o;
    return Objects.equals(this.cid, healthCheckOperation.cid) &&
        Objects.equals(this.isCompleted, healthCheckOperation.isCompleted) &&
        Objects.equals(this.operationMetadata, healthCheckOperation.operationMetadata) &&
        Objects.equals(this.health, healthCheckOperation.health);
  }

  @Override
  public int hashCode() {
    return Objects.hash(cid, isCompleted, operationMetadata, health);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class APIHealthCheckOperation {\n");
