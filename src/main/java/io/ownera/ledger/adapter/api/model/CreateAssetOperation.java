...
public class CreateAssetOperation {
  ...
  public CreateAssetOperation cid(String cid) {
    this.cid = cid;
    return this;
  }
  ...
  public CreateAssetOperation isCompleted(Boolean isCompleted) {
  ...
  public CreateAssetOperation error(CreateAssetOperationErrorInformation error) {
    this.error = error;
    return this;
  }
  ...
  public CreateAssetOperation response(AssetCreateResponse response) {
