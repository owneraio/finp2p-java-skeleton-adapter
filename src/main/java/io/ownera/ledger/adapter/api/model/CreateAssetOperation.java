 ...
 */
@JsonPropertyOrder({
  CreateAssetOperation.JSON_PROPERTY_CID,
  CreateAssetOperation.JSON_PROPERTY_IS_COMPLETED,
  CreateAssetOperation.JSON_PROPERTY_OPERATION_METADATA,
  CreateAssetOperation.JSON_PROPERTY_ERROR,
  CreateAssetOperation.JSON_PROPERTY_RESPONSE
})
...
public class CreateAssetOperation {
  ...
  public CreateAssetOperation() { 
  }

  public CreateAssetOperation cid(@javax.annotation.Nonnull String cid) {
    this.cid = cid;
    return this;
  }
  ...
  public CreateAssetOperation isCompleted(@javax.annotation.Nonnull Boolean isCompleted) {
  ...
  public CreateAssetOperation operationMetadata(@javax.annotation.Nullable OperationMetadata operationMetadata) {
  ...
  public CreateAssetOperation error(@javax.annotation.Nullable CreateAssetOperationErrorInformation error) {
    this.error = error;
    return this;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_ERROR, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setError(@javax.annotation.Nullable CreateAssetOperationErrorInformation error) {
    this.error = error;
  }


  public CreateAssetOperation response(@javax.annotation.Nullable AssetCreateResponse response) {
  ...
  @JsonProperty(value = JSON_PROPERTY_RESPONSE, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable AssetCreateResponse response) {
    this.response = response;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreateAssetOperation createAssetOperation = (CreateAssetOperation) o;
  ...
  public String toString() {
    ...
    sb.append("class CreateAssetOperation {\n");
