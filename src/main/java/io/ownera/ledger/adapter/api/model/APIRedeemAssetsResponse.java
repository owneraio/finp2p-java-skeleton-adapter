...
/**
 * APIRedeemAssetsResponse
 */
@JsonPropertyOrder({
  APIRedeemAssetsResponse.JSON_PROPERTY_CID,
  APIRedeemAssetsResponse.JSON_PROPERTY_IS_COMPLETED,
  APIRedeemAssetsResponse.JSON_PROPERTY_OPERATION_METADATA,
  APIRedeemAssetsResponse.JSON_PROPERTY_ERROR,
  APIRedeemAssetsResponse.JSON_PROPERTY_RESPONSE
})
...
public class APIRedeemAssetsResponse {
  ...
  public APIRedeemAssetsResponse() { 
  }

  public APIRedeemAssetsResponse cid(@javax.annotation.Nonnull String cid) {
    this.cid = cid;
    return this;
  }
  ...
  public APIRedeemAssetsResponse isCompleted(@javax.annotation.Nonnull Boolean isCompleted) {
  ...
  public APIRedeemAssetsResponse operationMetadata(@javax.annotation.Nullable APIOperationMetadata operationMetadata) {
  ...
  public APIRedeemAssetsResponse error(@javax.annotation.Nullable APIReceiptOperationErrorInformation error) {
    this.error = error;
    return this;
  }
  ...
  public APIRedeemAssetsResponse response(@javax.annotation.Nullable APIReceipt response) {
  ...
  /**
   * Return true if this RedeemAssetsResponse object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    APIRedeemAssetsResponse redeemAssetsResponse = (APIRedeemAssetsResponse) o;
    return Objects.equals(this.cid, redeemAssetsResponse.cid) &&
        Objects.equals(this.isCompleted, redeemAssetsResponse.isCompleted) &&
        Objects.equals(this.operationMetadata, redeemAssetsResponse.operationMetadata) &&
        Objects.equals(this.error, redeemAssetsResponse.error) &&
        Objects.equals(this.response, redeemAssetsResponse.response);
  }
  ...
  public String toString() {
    ...
    sb.append("class APIRedeemAssetsResponse {\n");
