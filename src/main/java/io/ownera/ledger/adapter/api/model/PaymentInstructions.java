...
@JsonPropertyOrder({
  ...
  PaymentInstructions.JSON_PROPERTY_INSTRUCTION
})
...
public class PaymentInstructions {
  ...
  public PaymentInstructions type(@javax.annotation.Nonnull TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public PaymentInstructions instruction(@javax.annotation.Nonnull String instruction) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.type, paymentInstructions.type) &&
        Objects.equals(this.instruction, paymentInstructions.instruction);
  }
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getInstruction() != null) {
      joiner.add(String.format(Locale.ROOT, "%sinstruction%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getInstruction()))));
    }
