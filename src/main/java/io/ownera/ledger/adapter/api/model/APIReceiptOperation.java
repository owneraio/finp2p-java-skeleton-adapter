 ...
 */
@JsonPropertyOrder({
  APIReceiptOperation.JSON_PROPERTY_CID,
  APIReceiptOperation.JSON_PROPERTY_IS_COMPLETED,
  APIReceiptOperation.JSON_PROPERTY_OPERATION_METADATA,
  APIReceiptOperation.JSON_PROPERTY_ERROR,
  APIReceiptOperation.JSON_PROPERTY_RESPONSE
})
...
public class APIReceiptOperation {
  ...
  public APIReceiptOperation() { 
  }

  public APIReceiptOperation cid(@javax.annotation.Nonnull String cid) {
    this.cid = cid;
    return this;
  }
  ...
  public APIReceiptOperation isCompleted(@javax.annotation.Nonnull Boolean isCompleted) {
  ...
  public APIReceiptOperation operationMetadata(@javax.annotation.Nullable APIOperationMetadata operationMetadata) {
  ...
  public APIReceiptOperation error(@javax.annotation.Nullable APIReceiptOperationErrorInformation error) {
    this.error = error;
    return this;
  }
  ...
  public APIReceiptOperation response(@javax.annotation.Nullable APIReceipt response) {
  ...
  /**
   * Return true if this receiptOperation object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    APIReceiptOperation receiptOperation = (APIReceiptOperation) o;
    return Objects.equals(this.cid, receiptOperation.cid) &&
        Objects.equals(this.isCompleted, receiptOperation.isCompleted) &&
        Objects.equals(this.operationMetadata, receiptOperation.operationMetadata) &&
        Objects.equals(this.error, receiptOperation.error) &&
        Objects.equals(this.response, receiptOperation.response);
  }
  ...
  public String toString() {
    ...
    sb.append("class APIReceiptOperation {\n");
