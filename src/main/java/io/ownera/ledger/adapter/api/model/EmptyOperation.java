 ...
 */
@JsonPropertyOrder({
  EmptyOperation.JSON_PROPERTY_CID,
  EmptyOperation.JSON_PROPERTY_IS_COMPLETED,
  EmptyOperation.JSON_PROPERTY_ERROR
})
...
public class EmptyOperation {
  ...
  public EmptyOperation cid(String cid) {
    this.cid = cid;
    return this;
  }
  ...
  public EmptyOperation isCompleted(Boolean isCompleted) {
  ...
  public EmptyOperation error(Object error) {
    this.error = error;
    return this;
  }
  ...
  /**
   * Return true if this emptyOperation object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    EmptyOperation emptyOperation = (EmptyOperation) o;
    return Objects.equals(this.cid, emptyOperation.cid) &&
        Objects.equals(this.isCompleted, emptyOperation.isCompleted) &&
        Objects.equals(this.error, emptyOperation.error);
  }

  @Override
  public int hashCode() {
    return Objects.hash(cid, isCompleted, error);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EmptyOperation {\n");
