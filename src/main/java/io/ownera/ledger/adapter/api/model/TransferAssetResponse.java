 ...
 */
@JsonPropertyOrder({
  TransferAssetResponse.JSON_PROPERTY_CID,
  TransferAssetResponse.JSON_PROPERTY_IS_COMPLETED,
  TransferAssetResponse.JSON_PROPERTY_OPERATION_METADATA,
  TransferAssetResponse.JSON_PROPERTY_ERROR,
  TransferAssetResponse.JSON_PROPERTY_RESPONSE
})
...
public class TransferAssetResponse {
  ...
  public TransferAssetResponse cid(@javax.annotation.Nonnull String cid) {
    this.cid = cid;
    return this;
  }
  ...
  public TransferAssetResponse isCompleted(@javax.annotation.Nonnull Boolean isCompleted) {
  ...
  public TransferAssetResponse operationMetadata(@javax.annotation.Nullable OperationMetadata operationMetadata) {
  ...
  public TransferAssetResponse error(@javax.annotation.Nullable ReceiptOperationErrorInformation error) {
    this.error = error;
    return this;
  }
  ...
  public TransferAssetResponse response(@javax.annotation.Nullable Receipt response) {
  ...
  public boolean equals(Object o) {
    ...
    TransferAssetResponse transferAssetResponse = (TransferAssetResponse) o;
