...
public class TransferAssetResponse {
  ...
  public TransferAssetResponse cid(String cid) {
    this.cid = cid;
    return this;
  }
  ...
  public TransferAssetResponse isCompleted(Boolean isCompleted) {
  ...
  public TransferAssetResponse error(ReceiptOperationErrorInformation error) {
    this.error = error;
    return this;
  }
  ...
  public TransferAssetResponse response(Receipt response) {
