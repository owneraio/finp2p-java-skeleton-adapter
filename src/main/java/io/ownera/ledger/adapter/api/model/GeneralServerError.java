 ...
 */
@JsonPropertyOrder({
  GeneralServerError.JSON_PROPERTY_CODE,
  GeneralServerError.JSON_PROPERTY_MESSAGE
})
...
public class GeneralServerError {
  /**
   * Gets or Sets code
   */
  ...
  public GeneralServerError code(@javax.annotation.Nonnull CodeEnum code) {
    this.code = code;
    return this;
  }
  ...
  public GeneralServerError message(@javax.annotation.Nonnull MessageEnum message) {
  ...
  public boolean equals(Object o) {
    ...
    GeneralServerError generalServerError = (GeneralServerError) o;
  ...
  public String toString() {
    ...
    sb.append("class GeneralServerError {\n");
