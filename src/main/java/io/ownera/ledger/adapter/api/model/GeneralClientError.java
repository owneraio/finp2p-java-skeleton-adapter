 ...
 */
@JsonPropertyOrder({
  GeneralClientError.JSON_PROPERTY_CODE,
  GeneralClientError.JSON_PROPERTY_MESSAGE
})
...
public class GeneralClientError {
  /**
   * Gets or Sets code
   */
  ...
  public GeneralClientError() { 
  }

  public GeneralClientError code(@javax.annotation.Nonnull CodeEnum code) {
    this.code = code;
    return this;
  }
  ...
  public GeneralClientError message(@javax.annotation.Nonnull MessageEnum message) {
  ...
  public boolean equals(Object o) {
    ...
    GeneralClientError generalClientError = (GeneralClientError) o;
  ...
  public String toString() {
    ...
    sb.append("class GeneralClientError {\n");
