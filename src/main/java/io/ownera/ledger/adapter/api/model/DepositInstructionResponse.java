...
public class DepositInstructionResponse {
  ...
  public DepositInstructionResponse cid(String cid) {
    this.cid = cid;
    return this;
  }
  ...
  public DepositInstructionResponse isCompleted(Boolean isCompleted) {
  ...
  public DepositInstructionResponse error(Object error) {
    this.error = error;
    return this;
  }
  ...
  public DepositInstructionResponse response(DepositInstruction response) {
  ...
  @JsonProperty(JSON_PROPERTY_RESPONSE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(DepositInstruction response) {
    this.response = response;
  }
