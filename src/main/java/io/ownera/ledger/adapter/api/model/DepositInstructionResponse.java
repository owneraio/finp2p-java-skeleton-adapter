...
import io.ownera.ledger.adapter.api.model.DepositInstruction;
 ...
 */
@JsonPropertyOrder({
  DepositInstructionResponse.JSON_PROPERTY_CID,
  DepositInstructionResponse.JSON_PROPERTY_IS_COMPLETED,
  DepositInstructionResponse.JSON_PROPERTY_OPERATION_METADATA,
  DepositInstructionResponse.JSON_PROPERTY_ERROR,
  DepositInstructionResponse.JSON_PROPERTY_RESPONSE
})
...
public class DepositInstructionResponse {
  ...
  @javax.annotation.Nullable
  private DepositInstruction response;

  public DepositInstructionResponse() { 
  }

  public DepositInstructionResponse cid(@javax.annotation.Nonnull String cid) {
    this.cid = cid;
    return this;
  }
  ...
  public DepositInstructionResponse isCompleted(@javax.annotation.Nonnull Boolean isCompleted) {
  ...
  public DepositInstructionResponse operationMetadata(@javax.annotation.Nullable OperationMetadata operationMetadata) {
  ...
  public DepositInstructionResponse error(@javax.annotation.Nullable Object error) {
    this.error = error;
    return this;
  }
  ...
  public DepositInstructionResponse response(@javax.annotation.Nullable DepositInstruction response) {
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public DepositInstruction getResponse() {
    return response;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_RESPONSE, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable DepositInstruction response) {
    this.response = response;
  }


  /**
   * Return true if this DepositInstructionResponse object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    DepositInstructionResponse depositInstructionResponse = (DepositInstructionResponse) o;
    return Objects.equals(this.cid, depositInstructionResponse.cid) &&
        Objects.equals(this.isCompleted, depositInstructionResponse.isCompleted) &&
        Objects.equals(this.operationMetadata, depositInstructionResponse.operationMetadata) &&
        Objects.equals(this.error, depositInstructionResponse.error) &&
        Objects.equals(this.response, depositInstructionResponse.response);
  }
  ...
  public String toString() {
    ...
    sb.append("class DepositInstructionResponse {\n");
