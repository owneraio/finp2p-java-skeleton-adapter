...
public class ReleaseOperationResponse {
  ...
  public ReleaseOperationResponse cid(String cid) {
    this.cid = cid;
    return this;
  }
  ...
  public ReleaseOperationResponse isCompleted(Boolean isCompleted) {
  ...
  public ReleaseOperationResponse error(ReceiptOperationErrorInformation error) {
    this.error = error;
    return this;
  }
  ...
  public ReleaseOperationResponse response(Receipt response) {
