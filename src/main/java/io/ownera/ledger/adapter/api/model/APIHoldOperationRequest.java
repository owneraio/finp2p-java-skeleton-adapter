...
@JsonPropertyOrder({
  ...
  APIHoldOperationRequest.JSON_PROPERTY_ASSET,
...
public class APIHoldOperationRequest {
  ...
  public APIHoldOperationRequest nonce(@javax.annotation.Nonnull String nonce) {
    this.nonce = nonce;
    return this;
  }
  ...
  public APIHoldOperationRequest operationId(@javax.annotation.Nonnull String operationId) {
  ...
  public APIHoldOperationRequest source(@javax.annotation.Nonnull APISource source) {
    this.source = source;
    return this;
  }
  ...
  public APIHoldOperationRequest destination(@javax.annotation.Nullable APIDestination destination) {
  ...
  public APIHoldOperationRequest quantity(@javax.annotation.Nonnull String quantity) {
  ...
  public APIHoldOperationRequest asset(@javax.annotation.Nonnull APIAsset asset) {
    this.asset = asset;
    return this;
  }
  ...
  public APIHoldOperationRequest expiry(@javax.annotation.Nonnull Integer expiry) {
    this.expiry = expiry;
    return this;
  }
  ...
  public APIHoldOperationRequest signature(@javax.annotation.Nonnull APISignature signature) {
  ...
  public APIHoldOperationRequest executionContext(@javax.annotation.Nullable APIExecutionContext executionContext) {
