 ...
 */
@JsonPropertyOrder({
  OperationStatusReceipt.JSON_PROPERTY_TYPE,
  OperationStatusReceipt.JSON_PROPERTY_OPERATION
})
...
public class OperationStatusReceipt {
  /**
   * Gets or Sets type
   */
  ...
  public OperationStatusReceipt() { 
  }

  public OperationStatusReceipt type(@javax.annotation.Nonnull TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public OperationStatusReceipt operation(@javax.annotation.Nonnull ReceiptOperation operation) {
  ...
  @JsonProperty(value = JSON_PROPERTY_OPERATION, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setOperation(@javax.annotation.Nonnull ReceiptOperation operation) {
    this.operation = operation;
  }


  /**
   * Return true if this operationStatusReceipt object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    OperationStatusReceipt operationStatusReceipt = (OperationStatusReceipt) o;
    return Objects.equals(this.type, operationStatusReceipt.type) &&
        Objects.equals(this.operation, operationStatusReceipt.operation);
  }
  ...
  public String toString() {
    ...
    sb.append("class OperationStatusReceipt {\n");
