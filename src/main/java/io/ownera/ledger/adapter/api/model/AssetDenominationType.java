 ...
 */
public enum AssetDenominationType {
  ...
  AssetDenominationType(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static AssetDenominationType fromValue(String value) {
    for (AssetDenominationType b : AssetDenominationType.values()) {
