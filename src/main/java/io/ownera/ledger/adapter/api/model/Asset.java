...
public class Asset extends AbstractOpenApiSchema {
    ...
    public static class AssetSerializer extends StdSerializer<Asset> {
        ...
        @Override
        public void serialize(Asset value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
    ...
    public static class AssetDeserializer extends StdDeserializer<Asset> {
        ...
        @Override
        public Asset deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
         ...
         */
        @Override
        public Asset getNullValue(DeserializationContext ctxt) throws JsonMappingException {
            throw new JsonMappingException(ctxt.getParser(), "Asset cannot be null");
        }
    }
    ...
    public Asset(CryptocurrencyAsset o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public Asset(FiatAsset o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public Asset(Finp2pAsset o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    static {
        ...
        JSON.registerDescendants(Asset.class, Collections.unmodifiableMap(schemas));
